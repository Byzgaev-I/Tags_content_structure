...
### Ссылка на песочницу [«История Монреаля»](https://codepen.io/Byzgaev-I/pen/NPxEGrL)   
...
```html
БЫЛО: <div class="content">
СТАЛО: <main class="content">
```
### <main> — семантический тег для основного контента страницы. Используется для главной информации (история Монреаля).  


```html
БЫЛО: <div class="last-news">
СТАЛО: <aside class="last-news">
```
### <aside> — семантический тег для дополнительного контента, связанного с основным, но не являющегося его частью (известные люди и города).


```html
БЫЛО: <div class="last-news-section">
СТАЛО: <section class="last-news-section">
```
### <section> — семантический тег для тематических разделов. У нас 2 раздела:
- "Известные люди из Канады"
- "Другие города Канады"
  
```html
БЫЛО: <div class="last-post">
СТАЛО: <article class="last-post">
```
...
### Процесс реализации
- Установите ширину контентной области 960px для элемента с классом news.  
- Расположите элемент с классом news по центру страницы по горизонтали.  
- Сделайте элемент с классом card-date блочным.  
- Установите внешний отступ снизу 20px для элемента с классом card-date.  
- Установите внутренний отступ сверху и снизу размером 50px, а слева и справа — размером 40px для элементов с классом card.  
- Установите ширину контентной области 320px для элементов с классом card.  
- Сделайте так, чтобы блоки с услугами располагались в ряд, как показано на макете.

### Ссылка на песочницу [«Последние новости»](https://codepen.io/Byzgaev-I/pen/OPMaMqV) 
...
### Ссылка на песочницу [«Раздел услуг веб-студии»](https://codepen.io/Byzgaev-I/pen/XJXyKdr?editors=1100)   
